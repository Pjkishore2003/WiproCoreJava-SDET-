...
public class Labtask2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        clickEvent(driver, "//input[@id='p-first-name']","kishore");
        clickEvent(driver, "//input[@id='p-last-name']","Pj");
        clickEvent(driver, "//input[@id='p-email']","pj@gmail.com");
        clickEvent(driver, "//input[@id='p-phone']","9234567");
        clickEvent(driver, "//input[@id='p-address']","telangana, Hyd, India");
//        clickEvent(driver, "//div[@class='dropdown-menu show']//input[@aria-label='Search']","India");

        // Enter traveller information
        clickEvent(driver, "//input[@name='firstname_1']", "kishore");
        clickEvent(driver, "//input[@name='lastname_1']", "Pj");
        Thread.sleep(500);
        clickEvent(driver, "//input[@name='firstname_2']", "pd");
        clickEvent(driver, "//input[@name='lastname_2']", "sai");
